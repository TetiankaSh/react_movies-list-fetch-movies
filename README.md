...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://TetiankaSh.github.io/react_movies-list-fetch-movies/) and add it to the PR description.
